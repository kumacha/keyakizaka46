  ...
  <v-main>
    ...
    <div class="outline_2nd">
      ...
      <div class="single_outline2_2nd">
        <p>
          同年7月から欅坂46のドラマ『徳山大五郎を誰が殺したか?』の主題歌に使用された。
        </p>
      </div>
              ...
              <div class="jacket_2nd">
                ...
                <div class="mask_2nd">
                  <div class="songs_2nd">
                    ...
                    2. 語るなら未来を…<br />
                    3. 渋谷からPARCOが消えた日<br />
                    4. 世界には愛しかない off vocal ver.<br />
                    5. 語るなら未来を… off vocal ver.<br />
                    6. 渋谷からPARCOが消えた日 off vocal ver.<br />
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="jacket_2nd">
                ...
                <div class="mask_2nd">
                  <div class="songs_2nd">
                    ...
                    3. ひらがなけやき<br />
                    4. 世界には愛しかない off vocal ver.<br />
                    5. ボブディランは返さない off vocal ver.<br />
                    6. ひらがなけやき off vocal ver.<br />
                  </div>
                </div>
              </div>
            </li>
    ...
    <div class="single_textbox_2nd">
      <div class="single_text_2nd">
        <p>
          夏を感じさせる清涼感と疾走感、<br />
          そして「未来には愛しかない」「悲しみなんてその時の空模様」「だれに反対されても心の向きは変えられない」など、
        </p>
      </div>
    ...
    <div class="single_movie_2nd">
      <div class="movie_contents_2nd">
        <v-container>
          <v-row>
            <v-col cols="12" md="4">
              <a href="https://youtu.be/83vyrFFjiqQ" target="_blank"
                ><v-img
                  src="https://firebasestorage.googleapis.com/v0/b/history-of-keyakizaka46.appspot.com/o/gallery%2Fsingle%2Fsekaai.jpg?alt=media&token=fe33b18c-2c33-4004-99b0-a38d6350277f"
                >
                </v-img
              ></a>
            </v-col>
            <v-col md="4">
              <a href="https://youtu.be/AFg1x-xCxa4" target="_blank"
                ><v-img
                  src="https://firebasestorage.googleapis.com/v0/b/history-of-keyakizaka46.appspot.com/o/gallery%2Fcoupling%2Fkatamira.jpg?alt=media&token=20fffd03-05d5-4f89-91ef-8023499e0607"
                >
                </v-img
              ></a>
            </v-col>
            <v-col md="4">
              <a href="https://youtu.be/UrT_xpmmNOs" target="_blank"
                ><v-img
                  src="https://firebasestorage.googleapis.com/v0/b/history-of-keyakizaka46.appspot.com/o/gallery%2Fcoupling%2Fmataatte.jpg?alt=media&token=11feb73b-9d55-477b-a951-e08472963fb0"
                >
                </v-img
              ></a>
            </v-col>
        ...
        <div class="movie_text_2nd">
          <p>
            この楽曲の中でポエトリーリーディングという詩の朗読に挑戦している。
          </p>
          <p>
            アイドルの楽曲としては珍しいこの手法が、楽曲にどのような効果をもたらしているのかを実際に聞いて感じてもらいたい。
          </p>
        </div>
      </div>
      <div class="gosingle">
