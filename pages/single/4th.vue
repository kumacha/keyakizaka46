  ...
  <v-main>
    ...
    <div class="outline4th">
      ...
      <div class="single_outline24th">
        <p>
          漢字のみのシングルタイトルは坂道シリーズにおいて初の出来事だった。
        </p>
      </div>
              ...
              <div class="jacket4th">
                ...
                <div class="mask4th">
                  <div class="songs4th">
                    ...
                    2. W-KEYAKIZAKAの詩<br />
                    3. 微笑みが悲しい<br />
                    4. 不協和音 off vocal ver.<br />
                    5. W-KEYAKIZAKAの詩　off vocal ver.<br />
                    6. 微笑みが悲しい off vocal ver.<br />
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="jacket4th">
                ...
                <div class="mask4th">
                  <div class="songs4th">
                    ...
                    4. 不協和音 off vocal ver.<br />
                    5. W-KEYAKIZAKAの詩　off vocal ver.<br />
                    6. 僕たちは付き合っている off vocal ver.<br />
                  </div>
                </div>
              </div>
            </li>
    ...
    <div class="single_textbox4th">
      ...
      <div class="single_text24th">
        <p>
          大勢の意見が正しいとされる空気をもねじ伏せるような描写もあり、不協和音は全体を通して周囲と合わせることへ<br />
          抵抗する主人公が描かれている。
        </p>
      </div>
      <HistoryLine />
    ...
    <div class="single_movie4th">
      <div class="movie_contents4th">
        <v-container>
          <v-row>
            <v-col cols="12" md="4">
              <a href="https://youtu.be/gfzuzDrVRVM" target="_blank"
                ><v-img
            ...
            <v-col md="4">
              <a href="https://youtu.be/s8j9hva3luI" target="_blank"
                ><v-img
            ...
            <v-col md="4">
              <a href="https://youtu.be/65v7JSBpQ4U" target="_blank"
                ><v-img
        ...
        <div class="movie_text4th">
          <p>
            歌詞の中でも最も特徴的なものはやはり「僕は嫌だ」という部分であり、
          </p>
          <p>
            これらのような強いメッセージ性を持っている点が、デビューシングル「サイレントマジョリティー」を彷彿とさせ話題となった。
          </p>
        </div>
      </div>
      <div class="gosingle">
