...
<div id="historycontents">
  <div class="Secondyear">
      <div class="ariakedate"><p>2018年4月6日-8日</p></div>
      <div class="Secondyeartext1"><p>欅坂46 2nd YEAR ANNIVERSATY LIVE</p></div>
      <div class="Secondyeartext2"><p>in 武蔵野の森総合スポーツプラザ メインアリーナ</p></div>
      <div class="Secondyeartext3"><p>センター平手不在で迎えた2周年記念ライブ</p></div>
      <div class="Secondyeartext4"><p>多くのメンバーがセンターを経験した</p></div>
      <HistoryLine/>
　　</div>
</div>
</template>
